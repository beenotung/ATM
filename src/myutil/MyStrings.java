...
public class MyStrings {
	...
	public static String BYE = "Thank you for using the ATM. Have a good day!";
	public static String ACCOUNT_NOT_FOUND = "The account is not found";
	public static String TRANSFER_SAME_ACCOUNT = "Please do not transfer to the same account as the sender";
}
